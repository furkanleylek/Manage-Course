...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body className={classNames('flex flex-col md:flex-row bg-foreground md:pl-[270px] overflow-x-hidden w-full overflow-y-scroll ', montserrat.className)}> {/* md:pl-72 for fixed sidebar */}
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
          enableSystem
